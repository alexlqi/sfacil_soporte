...
if ($_POST) {
    ...
    if(($ticket=Ticket::create($vars, $errors, SOURCE))){
        $msg='Solicitud de Ticket de Soporte Creada';
        ...
        $errors['err']=$errors['err']?$errors['err']:'Imposible crear un ticket, Por favor corriga los errores e intente nuevamente!';
    }
}
