...
<form action="tickets.php?id=<?php echo $ticket->getId(); ?>&a=edit" method="post" id="save"  enctype="multipart/form-data">
 ...
 <h2>Actualizar Ticket #<?php echo $ticket->getNumber(); ?></h2>
 <table class="form_table" width="940" border="0" cellspacing="0" cellpadding="2">
    <tbody>
        <tr>
            <th colspan="2">
                <em><strong>Información de Usuario</strong>: Usuario actualmente seleccionado</em>
            </th>
        </tr>
    <?php
    ...
    <tbody>
        <tr>
            <th colspan="2">
                <em><strong>Información de Ticket</strong>: Fecha de vencimiento anula el periodo de gracia establecido en Plan de Calidad de Servicio.</em>
            </th>
        </tr>
        <tr>
            ...
            <td>
                <select name="source">
                    <option value="" selected >&mdash; Selecionar Fuente &mdash;</option>
        ...
        <tr>
            ...
            <td>
                <select name="topicId">
                    <option value="" selected >&mdash; Seleccionar Tema de Ayuda &mdash;</option>
                    <?php
        ...
        <tr>
            ...
            <td>
                <select name="slaId">
                    <option value="0" selected="selected" >&mdash; Ninguno &mdash;</option>
                    <?php
                    if($slas=SLA::getSLAs()) {
        ...
        <tr>
            ...
            <td>
                ...
                <em>Hora basada en su zona horaria (GMT <?php echo $thisstaff->getTZoffset(); ?>)</em>
            </td>
        </tr>
    </tbody>
</table>
...
<table class="form_table" width="940" border="0" cellspacing="0" cellpadding="2">
    <tbody>
        <tr>
            <th colspan="2">
                <em><strong>Nota Interna</strong>: Razón para editar el Ticket (requerida)<font class="error">&nbsp;<?php echo $errors['note'];?></font></em>
            </th>
        </tr>
        <tr>
            <td colspan="2">
