        ...
        <td width="50%">
            <table border="0" cellspacing="" cellpadding="4" width="100%">
                <tr>
                    ...
                    <td><?php echo ucfirst($estatus); ?></td>
                </tr>
                <tr>
                    <th>Prioridad:</th>
...
?>
<ul id="threads">
    <li><a class="active" id="toggle_ticket_thread" href="#">Seguimiento de Ticket (<?php echo $tcount; ?>)</a></li>
</ul>
...
<div id="response_options">
    <ul class="tabs">
        ...
        <li><a id="reply_tab" href="#reply">Enviar Respuesta</a></li>
        <?php
        } ?>
        <li><a id="note_tab" href="#note">Enviar Nota Interna</a></li>
        <?php
        if($thisstaff->canTransferTickets()) { ?>
        <li><a id="transfer_tab" href="#transfer">Transferir Departamento</a></li>
        <?php
        }
    ...
    <form id="reply" action="tickets.php?id=<?php echo $ticket->getId(); ?>#reply" name="reply" method="post" enctype="multipart/form-data">
        ...
        <table style="width:100%" border="0" cellspacing="0" cellpadding="3">
           <tbody id="to_sec">
            ...
            <tr>
                <td width="120" style="vertical-align:top">
                    <label for="attachment">Archivos Adjuntos:</label>
                </td>
        ...
        <p  style="padding-left:165px;">
            <input class="btn_sm" type="submit" value="Enviar Respuesta">
            <input class="btn_sm" type="reset" value="Reiniciar">
        </p>
    </form>
    <?php
    } ?>
    <form id="note" action="tickets.php?id=<?php echo $ticket->getId(); ?>#note" name="note" method="post" enctype="multipart/form-data">
            ...
            <tr>
                ...
                <td>
                    <div>
                        ...
                        Título de la nota - resumen de la nota (opcional)</div>
       ...
       <p  style="padding-left:165px;">
           <input class="btn_sm" type="submit" value="Enviar Nota">
           <input class="btn_sm" type="reset" value="Reiniciar">
       </p>
   </form>
    <?php
    ...
    <form id="transfer" action="tickets.php?id=<?php echo $ticket->getId(); ?>#transfer" name="transfer" method="post" enctype="multipart/form-data">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="3">
            ...
            <tr>
                ...
                <td>
                    <?php
                        echo sprintf('<span class="faded">Ticket esta actualmente en<b>%s</b> department.</span>', $ticket->getDeptName());
                    ?>
                    <br>
            ...
            <tr>
                ...
                <td>
                    <textarea name="transfer_comments" id="transfer_comments"
                        placeholder="Ingrese las razones para transferir"
    ...
    <form id="assign" action="tickets.php?id=<?php echo $ticket->getId(); ?>#assign" name="assign" method="post" enctype="multipart/form-data">
        ...
        <table style="width:100%" border="0" cellspacing="0" cellpadding="3">
            ...
            <tr>
                <td width="120" style="vertical-align:top">
                    <label for="assignId"><strong>Reasignar a:</strong></label>
                </td>
                <td>
                    <select id="assignId" name="assignId">
                        <option value="0" selected="selected">&mdash; Selecionar un miembro del Staff &mdash;</option>
                        <?php
                    ...
                    if($ticket->isAssigned() && $ticket->isOpen()) {
                        echo sprintf('<div class="faded">Ticket actualmente asignado a <b>%s</b></div>',
                                $ticket->getAssignee());
            ...
            <tr>
                ...
                <td>
                    <textarea name="assign_comments" id="assign_comments"
                        ...
                        placeholder="Ingresar las razones o instrucciones para reasignar"
        ...
        <p  style="padding-left:165px;">
            <input class="btn_sm" type="submit" value="<?php echo $ticket->isAssigned()?'Reasignar':'Assignar'; ?>">
            <input class="btn_sm" type="reset" value="Reiniciar">
        </p>
    </form>
    <?php
