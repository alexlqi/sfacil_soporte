...
<form action="tickets.php?a=open" method="post" id="save"  enctype="multipart/form-data">
 ...
 <table class="form_table fixed" width="940" border="0" cellspacing="0" cellpadding="2">
    ...
    <tbody>
        <tr>
            <th colspan="2">
                <em><strong>Información de Usuario</strong>: </em>
            </th>
        </tr>
        <?php
        if ($user) { ?>
        ...
        <?php
            ...
            ?>
        <tr>
            <td width="160" class="required"> Email: </td>
            <td>
        ...
        <tr>
            <td width="160" class="required"> Nombre: </td>
            <td>
                <span style="display:inline-block;">
        ...
        <tr>
            <td width="160">Notificación de Ticket:</td>
            <td>
            <input type="checkbox" name="alertuser" <?php echo (!$errors || $info['alertuser'])? 'checked="checked"': ''; ?>>Enviar mensaje de alerta a usuario.
            </td>
        </tr>
        <?php
        } ?>
    ...
    <tbody>
        <tr>
            <th colspan="2">
                <em><strong>Información de Ticket &amp; Opciones:</em>
            </th>
        </tr>
        <tr>
            ...
            <td>
                <select name="source">
                    ...
                    <option value="Chat" <?php echo ($info['source']=='Chat')?'selected="selected"':''; ?>>Chat</option>
                    <option value="Inbox" <?php echo ($info['source']=='Inbox')?'selected="selected"':''; ?>>Inbox(Facebook)</option>
                </select>
        ...
        <tr>
            ...
            <td>
                ...
                <option value="" selected >&mdash; Selecione Tema de Ayuda &mdash;</option>
<?php                   }
        ...
        <tr>
            ...
            <td>
                <select name="deptId">
                    <option value="" selected >&mdash; Seleccione Departamento &mdash;</option>
                    <?php
         ...
         <tr>
            ...
            <td>
                <select name="slaId">
                    <option value="0" selected="selected" >&mdash; Predeterminado &mdash;</option>
                    <?php
                    if($slas=SLA::getSLAs()) {
         ...
         <tr>
            ...
            <td>
                ...
                <em>Hora basada en la zona horaria (GMT <?php echo $thisstaff->getTZoffset(); ?>)</em>
            </td>
        </tr>
        ...
        <tr>
            <td width="160">Asignar a:</td>
            <td>
                <select id="assignId" name="assignId">
                    <option value="0" selected="selected">&mdash; Seleccione un miembro del Staff &mdash;</option>
                    <?php
        ...
        <tr>
            <th colspan="2">
                <em><strong>Respuesta</strong>: Respuesta opcional de la cuestión anterior.</em>
            </th>
        </tr>
        <tr>
            <td colspan=2>
           ...
           <?php
            if(($cannedResponses=Canned::getCannedResponses())) {
                ...
                <div style="margin-top:0.3em;margin-bottom:0.5em">
                    ...
                    <select id="cannedResp" name="cannedResp">
                        <option value="0" selected="selected">&mdash; Selecciona una respuesta precargada &mdash;</option>
                        <?php
            ...
            <?php
                ...
                if($cfg->allowAttachments()) { ?>
                    <tr><td width="100" valign="top">Archivos Adjuntos:</td>
                        <td>
            ...
            if($thisstaff->canCloseTickets()) { ?>
                <tr>
                    <td width="100">Estado del Ticket:</td>
                    <td>
                        <input type="checkbox" name="ticket_state" value="closed" <?php echo $info['ticket_state']?'checked="checked"':''; ?>>
                        <b>Cerrar al Responder</b>&nbsp;<em>(Solo aplica si se introduce una respuesta)</em>
                    </td>
                </tr>
            <?php
            } ?>
             <tr>
                ...
                <td>
                    ...
                    <label><input type="radio" name="signature" value="dept"
                        <?php echo ($info['signature']=='dept')?'checked="checked"':''; ?>> Firma de Dept. (si existe)</label>
                </td>
             </tr>
            </table>
            </td>
        ...
        <tr>
            <td colspan=2>
                <textarea class="richtext ifhtml draft draft-delete"
                    placeholder="Nota interna opcional (recomendado en la asignación)"
