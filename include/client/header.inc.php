...
<head>
    ...
    <link rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/osticket.css?4827655" media="screen">
    <link rel="stylesheet" href="<?php echo ASSETS_PATH; ?>css/theme.css?4827655" media="screen">
    <link rel="stylesheet" href="<?php echo ASSETS_PATH; ?>css/print.css?4827655" media="print">
    ...
    <link rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/thread.css?4827655" media="screen">
    ...
    <script src="<?php echo ROOT_PATH; ?>js/jquery.multifile.js?4827655"></script>
    <script src="<?php echo ROOT_PATH; ?>js/osticket.js?4827655"></script>
    <script src="<?php echo ROOT_PATH; ?>scp/js/bootstrap-typeahead.js?4827655"></script>
            ...
            <p>
             <?php
                if ($thisclient && is_object($thisclient) && $thisclient->isValid()
                 ...
                 ?>
                <a href="<?php echo ROOT_PATH; ?>account.php">Perfil</a> |
                <a href="<?php echo ROOT_PATH; ?>tickets.php">Tickets <b>(<?php echo $thisclient->getNumTickets(); ?>)</b></a> -
                <a href="<?php echo $signout_url; ?>">Cerrar Sesión</a>
            <?php
            } elseif($nav) {
                ...
                if ($thisclient && $thisclient->isValid() && $thisclient->isGuest()) { ?>
                    <a href="<?php echo $signout_url; ?>">Cerrar Sesión</a><?php
                }
                elseif ($cfg->getClientRegistrationMode() != 'disabled') { ?>
                    <a href="<?php echo $signin_url; ?>">Iniciar Sesión</a>
<?php
                }
            } ?>
            </p>
