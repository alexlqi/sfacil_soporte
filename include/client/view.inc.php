...
<div id="msg_info">
    ...
    <strong>Buscando otros de sus Tickets?</strong></br>
    <a href="<?php echo ROOT_PATH; ?>login.php?e=<?php
        echo urlencode($thisclient->getEmail());
        ?>" style="text-decoration:underline">Inicie Sesión</a> o
    <a href="account.php?do=create" style="text-decoration:underline">registrar para una cuenta</a>
    para una mejor experiencia con nuestro Centro de Ticket de Soporte.</div>
    ...
    <tr>
        <td width="50%">
            <table class="infoTable" cellspacing="1" cellpadding="3" width="100%" border="0">
                <tr>
                    <th width="100">Estado del Ticket:</th>
...
<br>
<div class="subject">Asunto: <strong><?php echo Format::htmlchars($ticket->getSubject()); ?></strong></div>
<div id="ticketThread">
<?php
        ...
        <tr>
            <td colspan="2">
                ...
                if($ticket->isClosed()) {
                    ...
                    $msg='Para ayudarle mejor, por favor sea específico y detallado';
                }
                ?>
